...
var quizJSON = {
 ...
 { // Question 3
            ...
            "correct": "<p><span>👍 Bene!</span> Finora sono stati identificati circa 70 principi attivi della Cannabis, ma la ricerca prosegue.<br>Fonte:<a href='https://cannabismd.com/basics/cannabinoids/how-many-cannabinoids-does-cannabis-actually-have/' target='_blank'>How Many Cannabinoids Does Cannabis Actually Have?</a></p>",
            "incorrect": "<p><span>👎 Ops... No.</span> Finora sono stati identificati circa 70 principi attivi della Cannabis, ma la ricerca prosegue.<br>Fonte:<a href='https://cannabismd.com/basics/cannabinoids/how-many-cannabinoids-does-cannabis-actually-have/' target='_blank'>How Many Cannabinoids Does Cannabis Actually Have?</a></p>"// no comma here
        },
 ...
 { // Question 9
            ...
            "correct": "<p><span>👍 Ebbene sì</span> In Italia riguardano la Cannabis il 58% di tutte le operazioni antidroga, 96% dei sequestri, 80% delle segnalazioni ai Prefetti per uso e possesso personale, 48% delle denunce alle autorità giudiziarie. Il 30% dei detenuti in Italia si trova in carcere per reati legati alla droga. La maggior parte di essi è stato arrestato per lo spaccio della sostanza meno pericolosa: la Cannabis.<br>Fonte:<a href='https://megliolegale.it' target='_blank'>Megliolegale.it</a></p>",
            "incorrect": "<p><span>👎 Eh no</span> In Italia riguardano la Cannabis il 58% di tutte le operazioni antidroga, 96% dei sequestri, 80% delle segnalazioni ai Prefetti per uso e possesso personale, 48% delle denunce alle autorità giudiziarie. Il 30% dei detenuti in Italia si trova in carcere per reati legati alla droga. La maggior parte di essi è stato arrestato per lo spaccio della sostanza meno pericolosa: la Cannabis.<br>Fonte:<a href='https://megliolegale.it' target='_blank'>Megliolegale.it</a></p>"// no comma here
        },
 ...
 { // Question 10
            ...
            "correct": "<p><span>👍 Incredibile ma vero</span> 0 vittime: la Cannabis non è mai stata diretta causa di morte.In Italia è la dipendenza da alcol la più comune e rappresenta il primo fattore di rischio per la salute. Per l'Osservatorio Enpam-Eurispes, in Italia i decessi causati dall'alcol in 10 anni sono circa 430.000, una cifra enorme.⁣<br>Fonte:<a href='https://www.instagram.com/p/CEjNnrQjfyn/' target='_blank'>Megliolegale.it</a></p>",
            "incorrect": "<p><span>👎 Sbagliato</span> 0 vittime: la Cannabis non è mai stata diretta causa di morte. In Italia è la dipendenza da alcol la più comune e rappresenta il primo fattore di rischio per la salute. Per l'Osservatorio Enpam-Eurispes, in Italia i decessi causati dall'alcol in 10 anni sono circa 430.000, una cifra enorme.⁣<br>Fonte:<a href='https://www.instagram.com/p/CEjNnrQjfyn/' target='_blank'>Megliolegale.it</a></p>"// no comma here
        },
